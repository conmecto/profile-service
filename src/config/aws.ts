...
(async function checkOrCreateBucket() {
    ...
    try {
        ...
        await logger('Profile Service: ' + enums.PrefixesForLogs.AWS_CHECK_BUCKET_ERROR + error);
    }
    ...
    try {
        ...
        await logger('Profile Service: ' + enums.PrefixesForLogs.AWS_CREATE_BUCKET_ERROR + error);
    }
})();
